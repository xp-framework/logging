...
class ColoredConsoleAppenderTest extends TestCase {
  ...
  public function info() {
    ...
    $this->assertEquals("\033[00;00m[LOG] Test\033[0m", $out->bytes());
  }
  ...
  public function warn() {
    ...
    $this->assertEquals("\033[00;31m[LOG] Test\033[0m", $out->bytes());
  }
  ...
  public function error() {
    ...
    $this->assertEquals("\033[01;31m[LOG] Test\033[0m", $out->bytes());
  }
  ...
  public function debug() {
    ...
    $this->assertEquals("\033[00;34m[LOG] Test\033[0m", $out->bytes());
  }
}